...
INSERT INTO account VALUES('QA1', N'Nguyễn Minh Hiếu', 1, '1999-08-09', '0337358641', 'admin@gmail.com', '12345678', 0, 'avatar-default.jpg',1,null,1,null)
,('QA2', N'Nguyễn Thị Yến', 1, '1999-08-09', '0337358642', 'exam@gmail.com', '12345678', 1, 'avatar-default.jpg',1,null,1,null)
,('QA3', N'Nguyễn Minh Anh', 1, '1999-08-09', '0337358643', 'user@gmail.com', '12345678', 2, 'avatar-default.jpg',1,null,1,null)
,('QA4', N'Nguyễn Minh Hiếu', 1, '1999-08-09', '0337358645', 'admin4@gmail.com', '123456', 0, 'avatar-default.jpg',1,null,1,null)
,('QA5', N'Nguyễn Minh Hiếu', 1, '1999-08-09', '0337358646', 'admin5@gmail.com', '123456', 1, 'avatar-default.jpg',1,null,1,null)
,('QA6', N'Nguyễn Minh Hiếu', 1, '1999-08-09', '0337358647', 'admin6@gmail.com', '123456', 2, 'avatar-default.jpg',1,null,1,null)
,('QA7', N'Nguyễn Minh Hiếu', 1, '1999-08-09', '0337358648', 'admin7gmail.com', '123456', 0, 'avatar-default.jpg',1,null,1,null)
,('QA8', N'Nguyễn Minh Hiếu', 1, '1999-08-09', '0337358649', 'admin8@gmail.com', '123456', 1, 'avatar-default.jpg',1,null,1,null)


INSERT INTO exam VALUES ('EX1', 8, 20, 10, 9,1,0,null, 1, '2020-01-01',1,'2020-01-01')
,('EX2', 1, 40, 40, 10,20,10, null, 1, '2020-01-01',1,'2020-01-01')
,('EX3', 1, 40, 40, 10,20,10,'2021-01-01 12:00:00', 1, '2020-01-01',1,'2020-01-01')
,('EX4', 1, 40, 40, 10,20,10, null, 1, '2020-01-01',1,'2020-01-01')
,('EX5', 1, 40, 40, 10,20,10, null, 1, '2020-01-01',1,'2020-01-01')
, ('EX6', 1, 40, 40, 10,20,10,'2021-01-01 12:00:00', 1, '2020-01-01',1,'2020-01-01')
,('EX7', 1, 40, 40, 10,20,10,'2021-01-01 12:00:00', 1, '2020-01-01',1,'2020-01-01')


INSERT INTO question VALUES ('Q1', N'Toàn bộ những năng lực thể chất và tinh thần của con người được vận dụng vào quá trình sản xuất là', N'Bối cảnh xã hội', N'Các hợp tác', N'Tư liệu tiêu dùng', N'Sức lao động', N'Sức lao động', 0, 8,1,'2020-01-01',1,'2020-01-01')
...
,('Q3', N'Cá nhân, tổ chức thực hiện đầy đủ các nghĩa vụ, chủ động làm những gì mà pháp luật quy định phải làm là thực hiện pháp luật theo hình thức nào sau đây?', N'Thi thành pháp luật', N'Tuyên truyền pháp luật', N'Phổ biến pháp luật', N'Điều chỉnh pháp luật', N'Thi thành pháp luật', 0, 8,1,'2020-01-01',1,'2020-01-01')
,('Q4', N'Một trong những nội dung của quyền bình đẳng trong lao động là mọi công dân đều được thực hiện quyền lao động thông qua', N'Chiến lược phân bố dân cư', N'Lựa chọn việc làm phù hợp', N'Kế hoạch điều tra nhân lực', N'Nội dung thông cáo báo chí', N'Lựa chọn việc làm phù hợp', 0, 8,1,'2020-01-01',1,'2020-01-01')
...
, ('Q6', N'Bình đẳng về trách nhiệm pháp lí là bất kì công dân nào vi phạm pháp luật đề phải', N'Tổ chức phục dựng hiện trường', N'Tạo lập bằng chứng ngoại phạm', N'Chấm dứt mọi quan hệ dân sự', N'Bị xử lý theo quy định của pháp luật', N'Bị xử lý theo quy định của pháp luật', 0, 8,1,'2020-01-01',1,'2020-01-01')
,('Q7', N'Một trong những dấu hiệu cơ bản để xác định hành vi vi phạm pháp luật của cá nhân là người vi phạm dù', N'Năng lực trách nhiệm pháp lý', N'Các mối quan hệ xã hội', N'Điều kiện tiếp cận nhân chúng', N'Tiềm lực tài chính vững mạnh', N'Năng lực trách nhiệm pháp lý', 0, 8,1,'2020-01-01',1,'2020-01-01')
,('Q8', N'Khi muốn đề nghị sửa đổi nội dung trong hợp đồng lao động cần căn cứ vào nguyên tắc nào duới đây trong hợp đồng lao động ?', N'Tự do, công bằng, dân chủ.', N'Tự do, tự nguyện, bình đẳng.', N'Tự do ngôn luận.', N'Tự do thực hiện hợp đồng.', N'Tự do, tự nguyện, bình đẳng.',0, 8,1,'2020-01-01',1,'2020-01-01')
...
,('Q10', N'Công dân bình đẳng trong thực hiện quyền lao động được hiểu là mọi người đều có quyền', N'Tự do kinh doanh.', N'Tự do làm mọi việc.', N'Tìm kiếm việc làm.', N'Tìm kiếm thị trường.', N'Tìm kiếm việc làm.', 0, 8,1,'2020-01-01',1,'2020-01-01')
,('Q11', N'Các dân tộc Việt Nam được tham gia quản lí nhà nước và xã hội là biểu hiện quyền bình đẳng về', N'Kinh tế.', N'Chính trị', N'Văn hóa', N'Giáo dục', N'Chính trị', 1, 8,1,'2020-01-01',1,'2020-01-01')
,('Q12', N'Hình thức tín ngưỡng có tổ chức, với những quan niệm, giáo lí thể hiện sự tín ngưỡng và những hình thức lễ nghi thể hiện sự sùng bái tín ngưỡng ấy được gọi là', N'Tôn giáo.', N'Luật lệ.', N'Phong tục.', N'Văn hóa.', N'Tôn giáo.', 1, 8,1,'2020-01-01',1,'2020-01-01')
...
,('Q16', N'Công dân đủ năng lực theo quy định của pháp luật phải chịu trách nhiệm pháp lí khi thực hiện hành vi nào sau đây?', N'Mở rộng quy mô kinh doanh.', N'Từ chối kí hợp đồng lao động', N'Phản bác ý kiến trong các cuộc họp.', N'Công khai danh tính người tố cáo.', N'Công khai danh tính người tố cáo.', 2, 8,1,'2020-01-01',1,'2020-01-01')
...
,('Q21', N'Quyền bình đẳng của công dân trong kinh doanh được thể hiện ở nội dung nào sau đây?', N'Tự do lựa chọn loại hình doanh nghiệp.', N'Tự do thay đổi địa chỉ đăng kí kinh doanh.', N'Tự do liên kết với mọi tổ chức kinh tế.', N'Tự do cạnh tranh dưới mọi hình thức.', N'Tự do lựa chọn loại hình doanh nghiệp.', 1, 8,1,'2020-01-01',1,'2020-01-01')
,('Q22', N'Theo quy định của pháp luật, những tài sản nào sau đây thuộc quyền sở hữu của cả vợ và chồng?', N'Tất cả tài sản chung mà pháp luật quy định.', N'Tất cả tài sản được thừa kế riêng và chung.', N'Tất cả tài sản trước thời kì hôn nhân.', N'Tất cả tài sản trong thời kì hôn nhân.', N'Tất cả tài sản chung mà pháp luật quy định.', 1, 8,1,'2020-01-01',1,'2020-01-01')
